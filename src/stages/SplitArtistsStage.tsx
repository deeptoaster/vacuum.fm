...
export default function SplitArtistsStage(props: {
  ...
  return (
    <StageContainer>
      <h2>Part 1: Artist Names</h2>
      <Card width={40}>
        <h3>Scrobbles With Multiple Artists</h3>
        <p>
        ...
        <p>
          For consistency with scrobbles from typical music apps and Last.fm
          data, you can use this tool to assign a single artist name in these
          cases.
        </p>
        <p>
          There may be mistakes in the way we've split up the artist names
          below, so make sure to check the <label>Replacement</label> column to
          see if it looks right&mdash;or just type in the correct name yourself!
        </p>
